...
/**
 * MapCreator1 represents the map of the first level of Super Mario game.
...
public class MapCreator1
{
    ...
    {
        addbg(1, 14, BackGroundObject.bush1);
        addbg(11, 14, BackGroundObject.bush1);
        addbg(10, 14, BackGroundObject.bush1);
        addbg(15, 14, BackGroundObject.bush1);
        addbg(20, 14, BackGroundObject.bush1);
        addbg(42, 14, BackGroundObject.bush1);
        addbg(48, 14, BackGroundObject.bush1);
        addbg(60, 14, BackGroundObject.bush1);
        addbg(59, 14, BackGroundObject.bush1);
        addbg(69, 14, BackGroundObject.bush1);
        
        addbg(87, 14, BackGroundObject.bush1);
        addbg(92, 14, BackGroundObject.bush1);
        addbg(102, 14, BackGroundObject.bush1);
        addbg(105, 14, BackGroundObject.bush1);
        addbg(115, 14, BackGroundObject.bush1);
        
        addbg(132, 14, BackGroundObject.bush1);
        addbg(136, 14, BackGroundObject.bush1);
        
        addbg(140, 14, BackGroundObject.bush1);
        addbg(152, 14, BackGroundObject.bush1);
        
        addbg(160, 14, BackGroundObject.bush1);
        
        
        addbg(190, 14, BackGroundObject.bush1);
        for (int i = 1; i <= 220; i++)
        ...
        for (int i = 0; i < 200; i += 2)
        {
            if (rnd.nextBoolean() && rnd.nextBoolean() && rnd.nextBoolean())
                addbg(i, rnd.nextInt(4) + 2, BackGroundObject.cloud1);
    ...
    {
        map.addItem(new Castle(g(199), g(10)));
...
//        map.addWall(new PipeWall(g(56), g(11), 3));
    ...
    {
        //TODO: add FlowerEnemy on some pipes on both map1 and map 2
        
        map.addEnemy(new MushroomEnemy(g(22), g(14)));
        ...
        map.addEnemy(new MushroomEnemy(g(78), g(6)));
        
        map.addEnemy(new MushroomEnemy(g(96), g(14)));
        map.addEnemy(new MushroomEnemy(g(98), g(14)));
        
        map.addEnemy(new TurtleEnemy(g(108), g(14),true));
        map.addEnemy(new HedgeHogEnemy(g(110), g(14)));
        
        map.addEnemy(new MushroomEnemy(g(118), g(14)));
        map.addEnemy(new MushroomEnemy(g(120), g(14)));


        map.addEnemy(new MushroomEnemy(g(122), g(14)));
//        map.addEnemy(new MushroomEnemy(g(124), g(14)));
        map.addEnemy(new TurtleEnemy(g(124), g(14),false));
        map.addEnemy(new MushroomEnemy(g(126), g(14)));
